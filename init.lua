...
vim.keymap.set('i', '<D-/>', '<Esc>:normal gcc<CR><DOWN>', { desc = '[/] Toggle comment line' })
vim.keymap.set('n', '<D-/>', ':normal gcc<CR><DOWN>', { desc = '[/] Toggle comment line' })
...
vim.keymap.set('n', '<leader>e', ':Neotree<CR>', { desc = 'Focus neotree sidebar' })
